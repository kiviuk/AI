from haystack.nodes import EmbeddingRetriever, AnswerParser, PromptModel, PromptNode, PromptTemplate
...
def get_result(query):
    ...
    def initialize_model():
        return PromptModel(
            # model_name_or_path="model/mistral-7b-instruct-v0.1.Q5_K_M.gguf",
